...
console.log(luckyNumber, + adventurous); //TEST


if (luckyNumber === 2 && adventurous === true) {
    console.log("Roll the dice!");
}  else {
    console.log("The only way to beat the house is to not play at all.")
}
...
allowedNumPets = prompt('How many pets are allowed in your home?');

if (pets < allowedNumPets) {
    console.log("I can have more pets!");
} else if (pets === allowedNumPets) {
...
switch(luckyNumber) {
    ...
    case 2:
        ...
        break;
    case 3:
        console.log("Third is teh one with the polka dot dress");
        break;
    default:
